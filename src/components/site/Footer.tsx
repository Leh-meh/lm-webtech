        ...
        <div className="grid grid-cols-2 gap-10 text-sm md:grid-cols-3">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#sobre" className="text-foreground/80 hover:text-foreground">Sobre</a></li>
              <li><a href="#servicos" className="text-foreground/80 hover:text-foreground">Serviços</a></li>
              <li><a href="#projetos" className="text-foreground/80 hover:text-foreground">Projetos</a></li>
            </ul>
          </div>
          <div>
            <div className="text-xs uppercase tracking-[0.22em] text-muted-foreground">Contato</div>
            <ul className="mt-4 space-y-2">
              <li><a href="mailto:contato@lmwebtech.com" className="text-foreground/80 hover:text-foreground">contato@lmwebtech.com</a></li>
              <li><a href="#" className="text-foreground/80 hover:text-foreground">Instagram</a></li>
