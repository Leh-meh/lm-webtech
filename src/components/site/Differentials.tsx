...
export function Differentials() {
  ...
  return (
    <section id="diferenciais" className="relative py-20 md:py-28 lg:py-32 overflow-hidden">
      {" "}
        ...
        <div className="mt-16 md:mt-24 relative flex items-center justify-center h-[240px] sm:h-[280px] md:h-[320px]">
          ...
          <AnimatePresence mode="wait">
            {items.map((it, i) => (
              <motion.div
                key={it.k}
                className={`absolute w-full max-w-[90%] sm:max-w-xl mx-auto transition-all duration-500 ${getItemStyle(i)}`}
              >
                <div className="glass rounded-3xl p-6 sm:p-8 md:p-10 text-center">
                  ...
                  <h3 className="mt-3 text-xl sm:text-2xl md:text-3xl font-semibold"> {it.k}</h3>
